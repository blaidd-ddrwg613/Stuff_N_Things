package io.github.ddrwg613.stuffnthings.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<HasteBlock> HASTE_BLOCK = registerBlock("haste_block",
            ()-> new HasteBlock(BlockBehaviour.Properties.of()
                    .strength(2.0f,5.0f)
